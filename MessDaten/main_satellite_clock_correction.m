...
% t_off: signal trval time (actual pseudo range/light speed)
% Output:
% rohl_corrected: the pseudo-range after correcting satellite clock offset

function[rohl_corrected,delta_t_s]=main_satellite_clock_correction(filename,sat,rohl_measured,t_m,t_off)
...
% the gps system time at the time of transmission
t_m=t_m-t_off;
...
[rohl_corrected,delta_t_s]=satellite_clock_correction(rohl_measured,t_m,t_oc,a_f0,a_f1,a_f2,ecc,a,E_k,TGD);
