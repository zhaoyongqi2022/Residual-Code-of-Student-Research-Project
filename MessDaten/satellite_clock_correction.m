...
% TGD: Timing Group Delay (sec)
% 
% Output:
% rohl_corrected: final correction to pseudo-range 
% delta_t_s: satellite clock offset

function[rohl_corrected,delta_t_s]=satellite_clock_correction(rohl_measured,t_m,t_oc,a_f0,a_f1,a_f2,ecc,a,E_k,TGD)
% speed of light
c=299792458; % m/s
...
delta_t_s=delta_t_sv+delta_t_r-TGD;
